...
namespace ReadShpStepByStep
{
    public partial class MergeShpFile : Form
    {
        ...
        private void OpenFolderBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                OpenFolderName.Text = dialog.SelectedPath;
            }
            dialog.Dispose();
        ...
        private void SaveFileBtn_Click(object sender, EventArgs e)
        {
            ...
            if (dialog.ShowDialog() == DialogResult.OK)
            {
                ...
                SaveFileName2.Text = dialog.FileName;
        ...
        private void ReFreshProgressBar(int step)
        {
            ...
            LabShow.Text = ((int)(step * 100 / progressBar1.Maximum)).ToString() + "%";
            //label1.Refresh();
        }
        ...
        private void MergeFolderBtn_Click(object sender, EventArgs e)
        {
            ...
            ShapeFileFunction.ContorlMinAndMaxValue contorlMinAndMaxValue = new ShapeFileFunction.ContorlMinAndMaxValue(SetValue);
            ShapeFileFunction.RefreshValue refreshValue = new ShapeFileFunction.RefreshValue(ReFreshValueForm);

            ShapeFileFunction.MergeManyShpFile(files, TargetFile, contorlMinAndMaxValue, refreshValue);
